      ...
      <div className="space-y-6 max-w-3xl">
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-bold text-purple-600 dark:text-purple-400 hover:underline cursor-pointer select-none whitespace-nowrap shrink-0"
          >
            ← Back
          </button>
        </div>
                    ...
                    <div className="flex items-center justify-between gap-4 py-1 border-b border-slate-100 dark:border-slate-800/80">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        <a
                          ...
                          className="w-7 h-7 flex items-center justify-center text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-all border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40"
                      ...
                      <div className="flex items-center justify-between gap-4 py-1 border-b border-slate-100 dark:border-slate-800/80">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          <a
                            ...
                            className="w-7 h-7 flex items-center justify-center text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-all border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40 shadow-sm"
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 w-full sm:w-auto">
                  <select
                    ...
                    className="px-3 py-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200 rounded-xl text-xs font-bold focus:outline-none focus:ring-1 focus:ring-purple-500 cursor-pointer flex-grow sm:flex-grow-0"
                  >
                ...
                <div className="flex items-center gap-2 animate-scale-in text-xs bg-slate-50 dark:bg-slate-900/40 p-3 rounded-xl border border-slate-200 dark:border-slate-800 max-w-md self-start sm:self-end w-full sm:w-auto">
                  <div className="flex flex-col gap-1 flex-1">
                    ...
                    <input
                      ...
                      className="px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-850 bg-white dark:bg-slate-950 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500 cursor-pointer"
                    />
                  </div>
                  <div className="flex flex-col gap-1 flex-1">
                      ...
                      return (
                        <>
                              ...
                              <tr key={assignment.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/10 transition-colors">
                                ...
                                <td className="py-2 px-4 text-slate-500 dark:text-slate-400 text-[11px] whitespace-nowrap">
                                  {isTableEditing && edits ? (
                                    <input
                                      ...
                                      className="w-full px-2 py-1 text-xs rounded border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-250 focus:outline-none focus:ring-1 focus:ring-purple-500 cursor-pointer"
                                    />
                                  ) : (
                                    (() => {
                                ...
                                <td className="py-2 px-4">
                                  {isTableEditing && edits ? (
                                    ...
                                    <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-extrabold uppercase bg-purple-50 dark:bg-purple-950/30 border border-purple-100 dark:border-purple-900/50 text-purple-650 dark:text-purple-400 whitespace-nowrap">
                                ...
                                <td className="py-2 px-4 text-sm font-extrabold text-slate-900 dark:text-white min-w-[200px]">
                                  {isTableEditing && edits ? (
                                    <input
                                      ...
                                      className="w-full px-2 py-1 text-xs font-semibold text-slate-900 dark:text-white rounded border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 focus:outline-none focus:ring-1 focus:ring-purple-500"
                                    />
                                  ) : (
                          ...
                          <tr className="bg-slate-50/20 dark:bg-slate-900/10 border-t-2 border-slate-200 dark:border-slate-800 font-extrabold select-none">
                            ...
                            <td className="py-4 px-4 text-right text-sm font-black text-purple-600 dark:text-purple-400 whitespace-nowrap">
                              ₹{totalAmount}
                            </td>
                          </tr>
                        </>
        ...
        <div className="flex flex-wrap items-center gap-3 flex-grow max-w-3xl">
          ...
          <div className="relative flex-grow max-w-sm w-full">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-xs rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-purple-500"
          ...
          <select
            ...
            className="px-3 py-2 text-xs rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-1 focus:ring-purple-500"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...workers]
            ...
            <div
              ...
              className={`cursor-pointer bg-white dark:bg-slate-900 border rounded-2xl shadow-sm hover:shadow-md hover:border-purple-500/25 dark:hover:border-purple-500/15 p-5 relative overflow-hidden transition-all flex flex-col justify-between ${
                worker.isActive
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 shrink-0 self-center" onClick={(e) => e.stopPropagation()}>
                    <a
                      ...
                      className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-all border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40 shadow-sm"
                      title="Call Worker"
                    >
                      <Phone className="w-3.5 h-3.5" />
                    </a>
              ...
              <div className="mt-4 border-t border-slate-100 dark:border-slate-800/80 pt-3 flex items-center justify-between" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-purple-500 dark:hover:text-purple-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors cursor-pointer"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-white focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm"
