...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-sky-50/50 to-orange-50/30 px-4 sm:px-6 lg:px-8 relative overflow-hidden py-12">
      {/* Dynamic Animated Background Blobs */}
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-sky-200/40 blur-[100px] pointer-events-none animate-pulse-slow" />
      ...
      <div className="max-w-md w-full space-y-8 bg-white/70 backdrop-blur-xl p-8 rounded-2xl relative z-10 border border-white/80 shadow-[0_20px_50px_rgba(31,41,55,0.05)] hover:shadow-[0_24px_58px_rgba(31,41,55,0.08)] transition-all duration-500 ease-out animate-slide-up">
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              ...
              <div className="relative group">
                <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-400 group-focus-within:text-sky-600 transition-colors duration-200">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 bg-white/50 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-4 focus:ring-sky-500/10 focus:border-sky-500 transition-all duration-200 text-sm shadow-sm"
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={isLoading}
              className="group relative w-full flex justify-center py-3.5 px-4 rounded-xl border border-transparent text-sm font-semibold text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-4 focus:ring-sky-500/20 active:scale-[0.98] transition-all duration-200 cursor-pointer shadow-[0_10px_25px_-5px_rgba(14,165,233,0.3)] hover:shadow-[0_12px_28px_-5px_rgba(14,165,233,0.4)] disabled:opacity-50 disabled:pointer-events-none"
            >
              {isLoading ? (
        ...
        <div className="text-center pt-2">
          <a
            href="#login"
            className="text-xs font-bold text-sky-600 hover:text-sky-700 transition-colors hover:underline"
          >
