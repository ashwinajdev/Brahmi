      ...
      <div className="space-y-6">
        ...
        {isLoadingDetails || !workDetails ? (
          ...
          <div className="space-y-5 animate-fade-in">
            {/* Work Summary card */}
            <div className="glass-panel p-3.5 rounded-2xl border border-slate-200 bg-white space-y-2 relative select-none">
                  ...
                  {isWorkMenuOpen && (
                    <div className="absolute right-0 top-full z-50 mt-1 w-36 overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-lg">
                      <button
                        ...
                        className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs font-semibold text-red-600 hover:bg-red-50 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                      >
